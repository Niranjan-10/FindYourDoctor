...
class DoctorVisitedView extends StatefulWidget {
  @override
  _DoctorVisitedViewState createState() => _DoctorVisitedViewState();
}

class _DoctorVisitedViewState extends State<DoctorVisitedView> {
            ...
            builder: (context,snapshot){
              ...
              return ListView.builder(
                ...
                itemBuilder: (context,index){
                  ...
                  if (snapshot.data.documents[index].data['doctor id'] == loggedInUser.uid && snapshot.data.documents[index].data['status'] == 'Visited'){
                    return Column(
